...
const NAV_LINKS = ["Home", "About Me", "Case Studies", "Resume", "Contact"];
...
const PROJECTS = [
  ...
  { id: 2, title: "CoFundEstate", desc: "Real estate investing, made accessible and simple.", img: "https://images.unsplash.com/photo-1763671727638-5bc55bb9c980?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=600" },
  { id: 3, title: "ConnectLocaly", desc: "Connecting communities to trusted local businesses.", img: "https://images.unsplash.com/photo-1558707538-c56435bdcdf3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=600" },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900" style={{ fontFamily: "system-ui, sans-serif" }}>
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-16">
            <span className="tracking-[0.2em] text-xl" style={{ fontWeight: 700 }}>TERENCE</span>
              ...
              {NAV_LINKS.map((l) => (
                <button 
                  ...
                  className={`text-sm transition-colors ${
                    activeNav === l ? "text-gray-900" : "text-gray-500 hover:text-gray-800"
                  }`}
                >
                  {l}
                </button>
      ...
      {activeNav === "About Me" ? (
        ...
        <div className="relative max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            {/* Left Column */}
            <div>
              <h1 className="text-6xl md:text-7xl leading-[0.9] mb-8" style={{ fontFamily: "Georgia, serif" }}>
                PRODUCT<br />DESIGNER
              </h1>
              <p className="text-gray-600 mb-4 text-lg leading-relaxed max-w-lg">
      ...
      <section className="py-20 bg-gray-50 relative overflow-hidden" id="projects">
        ...
        <div className="relative max-w-7xl mx-auto px-8">
          <h2 className="text-4xl text-gray-900 mb-16 text-center" style={{ fontFamily: "Georgia, serif" }}>Case Studies</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {PROJECTS.map((project) => (
              <div key={project.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow group cursor-pointer">
      ...
      <section className="py-6 relative overflow-hidden" id="contact" style={{ backgroundColor: "#555B73" }}>
        ...
        <div className="relative max-w-md mx-auto px-6">
          <h2 className="text-xl text-white mb-1 text-center" style={{ fontFamily: "Georgia, serif" }}>Contact Me</h2>
