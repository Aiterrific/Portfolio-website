    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="py-12 md:py-16">
        <div className={`${CASE_STUDY_WIDTH} mx-auto grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-12 text-center`}>
          {STATS.map((stat) => (
            <div key={stat.label}>
              <p className="text-4xl md:text-5xl text-gray-900">{stat.value}</p>
              <p className="mt-2 text-xs md:text-sm uppercase tracking-wide text-gray-600">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
